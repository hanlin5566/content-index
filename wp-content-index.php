	...
	if(!empty($hlist)):
		...
		if(empty($hunits)):
			...
			if($_CONFIGURE["hidebt"]):
				$contentIndex .= ''
					.'<span class="content-index-toctoggle">[<a id="content-index-togglelink" href="javascript:content_index_toggleToc()">'.__("show", "content-index").'</a>]</span>'
					.'
<script type="text/javascript" language="javascript">
window.content_index_showTocToggle=false;function content_index_toggleToc(){var tts="'.__("show", "content-index").'";var tth="'.__("hide", "content-index").'";if(window.content_index_showTocToggle){window.content_index_showTocToggle=false;document.getElementById("content-index-contents").style.display="none";document.getElementById("content-index-togglelink").innerHTML=tts}else{window.content_index_showTocToggle=true;document.getElementById("content-index-contents").style.display="block";document.getElementById("content-index-togglelink").innerHTML=tth}}
</script>
';
			endif;
			
			$contentIndex .= '<ul id="content-index-contents" style="display: none;">'.$hunits.'</ul>';
			$contentIndex .= '</div>';
